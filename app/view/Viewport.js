            ...
            dockedItems: [
                {
                    ...
                    items: ['-', {
                        xtype: 'button',
                        frame: true,
                        text: 'Untusoft Support',
                        iconCls: 'icoHelp',
	                    action: 'supportBtn',
	                    src: 'http://untusoft.com/'
                    }, '-']
                }
            ]*/
        });
            ...
            items: [
                {
                    ...
                    items: [
                        {
                            text: 'Copyright (C) 2014 Untusoft |:|  v' + me.version,
                            iconCls: 'icoGreen',
                            disabled: true
                        },
                        '->',
                        {
                            xtype: 'button',
                            text: me.user.title + ' ' + me.user.fname +' ' + me.user.lname,
                            scale: 'small',
//                            style: 'height: 42px',
//                            iconCls: isEmerAccess ? 'icoUnlocked32' : 'icoDoctor',
//                            iconCls: 'icoLogout',
...
*/
    ...
    removeAppMask: function(){
        ...
        window.document.title = 'BJT Logistics';
    },
